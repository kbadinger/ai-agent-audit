...
from .config import ACTIVE_PROFILE, AUDIT_DIR
...
class Alerter:
    ...
    def _format_message(finding: Finding) -> str:
        ...
        parts = [f"[{ACTIVE_PROFILE.display_name} CRITICAL] {finding.title}"]
        tags = []
    ...
    def _send_macos_notification(self, finding: Finding, config: dict) -> None:
        ...
        if platform.system() != "Darwin":
            ...
            return
        title = f"{ACTIVE_PROFILE.display_name} Audit: CRITICAL"
